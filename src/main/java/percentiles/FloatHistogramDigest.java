 ...
 */
public class FloatHistogramDigest implements Digest {
  ...
  public FloatHistogramDigest() {
    histogram = new FloatHistogram(1e-12, (double) Long.MAX_VALUE, 50);
  }
  ...
  public String toString() {
    ...
    return "FloatHistogramDigest: worst=" + buckets.length + ", size=" + size + ", bytes=" + (size * 8);
  }
}
